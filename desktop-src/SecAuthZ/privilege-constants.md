...
User Right: Back up files and directories.<br/>If the file is located on a removable drive, <strong>SE_SECURITY_NAME</strong><br/> is required to have ACCESS_SYSTEM_SECURITY.</td>
</tr>
<tr class="even">
...
User Right: Restore files and directories.<br/>If the file is located on a removable drive, <strong>SE_SECURITY_NAME</strong><br/> is required to have ACCESS_SYSTEM_SECURITY.</td>
</tr>
<tr class="odd">
